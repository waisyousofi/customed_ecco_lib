...
class OutputSeq:
    ...
    def run_nmf(self, **kwargs):
        ...
        Returns an [NMF]() object which holds
...
class NMF:
    ...
    def __init__(self, activations: Dict[str, np.ndarray],
        ...
        print('n_output_tokens', n_output_tokens, activations.shape)
        ...
        print("self.components.shape", self.activations.shape,self.components.shape)
    ...
    def explore(self, input_sequence: int = 0, **kwargs):
        ...
        # # if 'printJson' in kwargs and kwargs['printJson']:
        print(self.config['tokenizer_config'])
        return data,factors,self.components
        # return data, factors
